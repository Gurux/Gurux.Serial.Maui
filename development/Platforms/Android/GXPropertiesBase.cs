...
namespace Gurux.Serial
{
    internal class GXPropertiesBase
    {
        ...
        {
            return Properties.Resources.Port + "\r\n" + serial.Port;
        }

        private string GetBaudRate()
        {
            return Properties.Resources.BaudRate + "\r\n" + serial.BaudRate;
        }

        private string GetDataBits()
        {
            return Properties.Resources.DataBits + "\r\n" + serial.DataBits;
        }

        private string GetParity()
        {
            return Properties.Resources.Parity + "\r\n" + serial.Parity;
        }
        ...
        private string GetStopBits()
        {
            ...
            */
            return Properties.Resources.StopBits + "\r\n" + value;
        }
        ...
        private string GetChipset()
        {
            ...
            {
                return Properties.Resources.Chipset + "\r\n" + serial._Chipset.Chipset.ToString();
            }
            return "";
        }
