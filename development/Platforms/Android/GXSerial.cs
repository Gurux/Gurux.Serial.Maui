...
namespace Gurux.Serial
{
    ...
    /// See help in http://www.gurux.fi/Gurux.Serial
    /// </summary>
    public class GXSerial : IGXMedia2, INotifyPropertyChanged, IDisposable
    {
        ...
        /// </summary>
        private readonly GXUsbReciever _Receiver;
        /// <summary>
        /// Used chipset.
        /// </summary>
        ...
        public GXSerial(Android.App.Activity activity) : this((Context)activity)
        {
        }
         ...
         */
        public GXSerial(Android.App.Activity activity, string port, int baudRate,
                        int dataBits, Parity parity,
